...
function Todo() {
  ...
  const { apiUrl, token, setIsLoading, isLoading } = useContext(storeContext);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="mt-6 space-y-2">
        ...
        <p className="text-gray-600">Price: ₦{todo.priceRequest}</p>
        <p className="text-gray-600">Category: {todo.category?.name}</p>
